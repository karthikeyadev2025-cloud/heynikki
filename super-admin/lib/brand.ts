...
// / orange #F59E0B on dark background. This file previously matched that
// superseded palette even though nothing imported it.
//
// This app's actual page.tsx still runs its own dark purple/indigo scheme
// (#07070D / #8B5CF6 / #A78BFA / #EEEEFF) — a fifth, unrelated palette. It
// needs to be migrated to import NIKKI from here next.
