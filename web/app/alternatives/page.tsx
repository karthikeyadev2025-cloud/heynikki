    ...
    >
      ...
      <p>
        {/* NOT "every call at once" — concurrency is capped by the plan
            (2 on Shop, 4 on Team, 6 on Business, per the plans table).
            "Several at once" is the honest version of the same advantage
            over a receptionist, who handles exactly one. */}
        <strong>From ₹3,999 a month</strong>, answering several calls at once, at any hour, in
      ...
      <p>
        ...
        If that number is smaller than ₹3,999, none of this is urgent. For most clinics
      ...
      <Faq items={[
        { q: "Is an AI receptionist better than hiring a person?",
          a: "Not better — different. A person is better at judgement and at regulars; an AI answers several calls at once, at any hour, for about a quarter of the cost. If your volume already justifies a full-time receptionist, hire one." },
        ...
        { q: "What does an AI receptionist cost in India?",
          a: "HeyNikki starts at ₹3,999 a month for 400 minutes of answering plus a telecaller seat, with 100 free minutes to start. A receptionist in Hyderabad costs roughly ₹15,000 a month and works one shift." },
